...
// it('When work timer is clicked with default (input of 25), check if timer
// display updates to 25:00 correctly', () => {
...
// it('Testing work timer when work time input is 5, timer should display
// 05:00', () => {
...
//         expect($el).to.have.css('background-color', 'rgb(158, 90, 99)'); //
//         Must use rgb in cypress
//       });
//     });

//   it('When work timer is clicked, check if short break changes to light
//   pink', () => {
//       cy.get('#workTime').click();
...
//   it('When work timer is clicked, check if start button changes to light
//   pink', () => {
//       cy.get('#workTime').click();
...
//   it('When work timer is clicked, check if stop button changes to light
//   pink', () => {
//       cy.get('#workTime').click();
...
//   it('When Long Break is clicked with input of 15, check if timer display
//   updates to 15:00 correctly', () => {
...
//   it('When Long Break is clicked, check if long break button turns dark
//   pink', () => {
//     cy.get('#longBreak').click();
//     cy.get('#longBreak').should(($el) => {
//       expect($el).to.have.css('background-color', 'rgb(158, 90, 99)'); //
...
//   it('When Long Break button is clicked, check if short break button change
//   to dark blue', () => {
//     cy.get('#longBreak').click();
//     cy.get('#shortBreak').should(($el) => {
...
//   it('When Long Break button is clicked, check if work timer button change to
//   dark blue', () => {
//     cy.get('#longBreak').click();
...
//   it('When Long Break button is clicked, check if start button change to dark
//   blue', () => {
//     cy.get('#longBreak').click();
...
//   it('When Long Break button is clicked, check if stop button change to dark
//   blue', () => {
//     cy.get('#longBreak').click();
...
//   it('When Short Break is clicked with input of 5, check if timer display
//   updates to 05:00 correctly', () => {
...
//   // Checking style: https://github.com/cypress-io/cypress/issues/1393
//   it('When Short Break is clicked, check if short break button changes to
//   dark pink', () => {
//       cy.get('#shortBreak').click();
//       cy.get('#shortBreak').should(($el) => {
//         expect($el).to.have.css('background-color', 'rgb(158, 90, 99)'); //
...
//   it('When Short Break is clicked, check if long break button changes to
//   lighter blue', () => {
//       cy.get('#shortBreak').click();
//       cy.get('#longBreak').should(($el) => {
...
//     it('When Short Break is clicked, check if work timer button changes to
//     lighter blue', () => {
//       cy.get('#shortBreak').click();
//       cy.get('#workTime').should(($el) => {
//         expect($el).to.have.css('background-color', 'rgb(88, 131, 206)'); //
...
//     it('When Short Break is clicked, check if Start button changes to lighter
//     blue', () => {
//       cy.get('#shortBreak').click();
//       cy.get('#StartButton').should(($el) => {
//         expect($el).to.have.css('background-color', 'rgb(88, 131, 206)'); //
...
//     it('When Short Break is clicked, check if Stop button changes to lighter
//     blue', () => {
//       cy.get('#shortBreak').click();
//       cy.get('#StopButton').should(($el) => {
//         expect($el).to.have.css('background-color', 'rgb(88, 131, 206)'); //
